...
Firmware: C++ code for the ATmega328P microcontroller in PCB_Watch

Hardware: PCB production files for manufacturing the watch PCB in PCB_Watch_Files
...
The original PCB concept was designed by Taifur (LumiDial).
The firmware was written by Antara for the ATmega328P microcontroller.
...
Includes manufacturing-ready files (e.g. Gerbers)
